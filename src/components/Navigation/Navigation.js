    ...
    <div className="navigation">
      {loggedIn !== true ? (
        <div className="navigation__wrappAutch">
          <button onClick={switchPageSignup} className="navigation__btnAutch">
            Регистрация
          </button>
          <button
            onClick={switchPageSignin}
            className="navigation__btnAutch navigation__btnAutch_background"
          >
            Войти
          </button>
        </div>
